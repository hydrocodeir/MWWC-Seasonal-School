...
class RegisterForm(FlaskForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.university.choices = [
            ...
            ('دانشگاه علوم کشاورزی و منابع طبیعی ساری', 'دانشگاه علوم کشاورزی و منابع طبیعی ساری'),
            ('دانشگاه علوم کشاورزی و منابع طبیعی گرگان', 'دانشگاه علوم کشاورزی و منابع طبیعی گرگان'),
        ]
